...
<body data-base-url="<?php echo base_url(); ?>">
        ...
        <div class="container">
            <div class="admin-header-inner">
                ...
                <nav class="admin-nav" aria-label="Admin navigation">
                    ...
                    <a href="<?php echo base_url('admin/leads.php'); ?>" class="admin-nav-link <?php echo (basename($_SERVER['PHP_SELF']) === 'leads.php') ? 'active' : ''; ?>">Leads</a>
                    <a href="<?php echo base_url('admin/analytics.php'); ?>" class="admin-nav-link <?php echo (basename($_SERVER['PHP_SELF']) === 'analytics.php') ? 'active' : ''; ?>">Analytics</a>
                </nav>
    ...
    <aside class="admin-sidebar" id="admin-sidebar" aria-label="Admin sidebar">
        <nav class="admin-sidebar-nav">
            ...
            <a href="<?php echo base_url('admin/leads.php'); ?>" class="admin-sidebar-link <?php echo (basename($_SERVER['PHP_SELF']) === 'leads.php') ? 'active' : ''; ?>">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
            ...
            <a href="<?php echo base_url('admin/analytics.php'); ?>" class="admin-sidebar-link <?php echo (basename($_SERVER['PHP_SELF']) === 'analytics.php') ? 'active' : ''; ?>">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
